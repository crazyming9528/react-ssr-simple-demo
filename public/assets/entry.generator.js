...
const React = __webpack_require__(1),
    ...
    TestApp = __webpack_require__(12);
...
ReactDOM.render(
    React.createElement(TestApp, {initialCount: APP_PROPS.initialCount}),
...
class TestApp extends React.Component {
    ...
    render() {
        let ele = this.state ? React.createElement("span", {onClick: () => {
            this._increment()
        }}, this.state.count, "(Click here will update)") : React.createElement("span", null, "loading");
        return (
